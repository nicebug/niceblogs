...
BLOG_AUTHOR = "damonhu"  # (translatable)
BLOG_TITLE = "Go for it"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://nicebug.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nicebug.github.io/"
BLOG_EMAIL = "alldoisbug@gmail.com"
BLOG_DESCRIPTION = "go for what you want"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('#', 'About me', 'icon-user'),
        ('#', 'My Twitter', 'icon-twitter'),
        ('https://github.com/nicebug', 'My Github', 'icon-github'),
    )
}
